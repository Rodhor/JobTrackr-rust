        ...
        <Sidebar.MenuItem>
            <Tooltip.Provider>
                <Tooltip.Root>
                    ...
                    <Tooltip.Content
                        >View overall activity and stats</Tooltip.Content
                    >
                </Tooltip.Root>
            </Tooltip.Provider>
        </Sidebar.MenuItem>
        ...
        <Sidebar.MenuItem>
            <Tooltip.Provider>
                <Tooltip.Root>
                    ...
                    <Tooltip.Content
                        >Browse and manage job listings</Tooltip.Content
                    >
                </Tooltip.Root>
            </Tooltip.Provider>
        </Sidebar.MenuItem>
        ...
        <Sidebar.MenuItem>
            <Tooltip.Provider>
                <Tooltip.Root>
                    ...
                    <Tooltip.Content
                        >Manage your job applications</Tooltip.Content
                    >
                </Tooltip.Root>
            </Tooltip.Provider>
        </Sidebar.MenuItem>
        ...
        <Sidebar.MenuItem>
            <Tooltip.Provider>
                <Tooltip.Root>
                    ...
                    <Tooltip.Content
                        >View and organize company profiles</Tooltip.Content
                    >
                </Tooltip.Root>
            </Tooltip.Provider>
        </Sidebar.MenuItem>
        ...
        <Sidebar.MenuItem>
            <Tooltip.Provider>
                <Tooltip.Root>
                    ...
                    <Tooltip.Content
                        >View and manage people profiles</Tooltip.Content
                    >
                </Tooltip.Root>
            </Tooltip.Provider>
        </Sidebar.MenuItem>
        ...
        <Sidebar.MenuItem>
            <Tooltip.Provider>
                <Tooltip.Root>
                    ...
                    <Tooltip.Content
                        >Track interviews, calls, and meetings</Tooltip.Content
                    >
                </Tooltip.Root>
            </Tooltip.Provider>
        </Sidebar.MenuItem>
